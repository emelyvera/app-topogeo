export const servicios = {
    topografia: {
        ...
        topografiaFotogrametria: {
            topografia: 'La topografía nos ofrece conocer el estado real del terreno y su distribución espacial, realizado con equipos y personal profesional para las labores y  obtención de resultados excelentes para cualquier proyecto o trámite requerido. TOPOGEO MV, te brinda precisiones exactas del terreno o proyecto.',
            fotogrametria: 'La fotogrametría se realiza por medio de drones, esta última te da la ventaja de tener una imagen real georreferenciada de tu propiedad, o si lo prefieres se puede combinar lo mejor de ambas para obtener el resultado esperado.'
        },
    ...
    geologiaCivil: {
        minera: {
            ...
            serviciosMineros: [
                ...
                'Levantamiento y localización en avance de labores.',
                'Auditoria minera.',
                'Muestro geológico y localización de mallas para estudios geofísicos y geoquímicos.',
                'Cartografía base.',
                'Exploración minera.',
        ...
        infraestructura: {
            ...
            serviciosIngra: [
                'Creación de superficies de terreno.',
                'Localización, replanteo y seguimiento de obras.',
                'Cálculo de volúmenes de material.',
                'Delimitación predial y servidumbres.',
                'Trazado de ejes y nivelaciones.'
            ]
        }
    },
    estudios: [
